...
const Contact = () => {
      ...
      try {
        await emailjs.send(
          ...
          "template_5bng5x9", // your EmailJS template ID
          {
            ...
            time: new Date().toLocaleString(), // ✅ added parentheses
          },
  ...
  return (
    <>
      <section
        id="contact"
        className="bg-gray-50 dark:bg-[#0D1117] text-gray-800 dark:text-gray-200 px-6 py-16"
      >
        <div className="max-w-6xl mx-auto p-6  rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="col-span-1 border rounded-md border-gray-300 dark:border-gray-600">
              <div className="p-6">
                ...
                <div className="flex items-center space-x-3 mt-4 text-gray-700 dark:text-gray-300">
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900">
                    <MdOutlinePhoneInTalk className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <a
                ...
                <div className="flex items-center space-x-3 mt-4 text-gray-700 dark:text-gray-300">
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900">
                    <BsLinkedin className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <a
            ...
            <div className="col-span-2 border rounded-md border-gray-300 dark:border-gray-600 p-6">
              <form onSubmit={formik.handleSubmit}>
                ...
                <button
                  type="submit"
                  className="px-6 py-3 font-medium bg-blue-600 dark:bg-transparent border border-transparent dark:border dark:border-white/50 text-white dark:text-white/50 rounded-md hover:bg-transparent hover:text-blue-600 hover:border hover:border-blue-600 transition-colors"
                >
                  Submit
                </button>
              </form>
